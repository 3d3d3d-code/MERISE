CREATE DATABASE IF NOT EXISTS tp_agence_voyage CHARACTER SET utf8 ;
...
CREATE TABLE IF NOT EXISTS suggest (
    ...
    FOREIGN KEY (theme_code)
        REFERENCES themes (theme_code)
);

INSERT INTO clients (client_lastname,client_firstname,client_email,client_phone,client_added,client_password)VALUES('reda','hamza','redair@aol.com',0206020802,'jklhg','qwerty');

DROP database tp_agence_voyage
